...
class SwitchAlert(Base):
    ...
    category_id = Column(Integer, ForeignKey("problem_categories.category_id", ondelete="SET NULL"))
    alert_type = Column(String(255), nullable=False)
    severity = Column(String(255))
    message = Column(String(255))
    assigned_to_user_id = Column(Integer, ForeignKey("users.user_id", ondelete="SET NULL"))
