...
class NetworkNode(Base):
    ...
    node_type = Column(String(255), nullable=False, default="generic")
    ...
    outgoing_routes = relationship(
        "FORoute", foreign_keys="FORoute.start_node_id", back_populates="start_node"
    )
    incoming_routes = relationship(
        "FORoute", foreign_keys="FORoute.end_node_id", back_populates="end_node"
    )
